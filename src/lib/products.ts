import { talitaProducts as localProducts } from "@/data/talitaProducts";
...
export function normalizeSupabaseProduct(product: Record<string, unknown>): AffiliateProduct {
  return {
    ...
    preco_cliente_base: toNumber(product.preco_cliente_base as number | string | null) ?? undefined,
    preco_revendedor_atacado: toNumber(product.preco_revendedor_atacado as number | string | null) ?? undefined,
  };
}
